...
<div class="header">
  <span class="header_left_panel1">
    <a href="/home">
      ...
      <img class="leader_left_panel1_logo" src="/blue-icon.svg" alt="Data Marketplace" />
  ...
  <span class="header_right_panel1">
    ...
    {#if currentUser}
      ...
      <button style="position: relative; top: -14px; left: -28px;" on:click={goToPublish} class="rounded_button_outlined">+ Post</button>
